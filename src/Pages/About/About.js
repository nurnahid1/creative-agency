    ...
    return (
        <div className='mb-8 md:mb-12 mt-16 md:mt-24'>
            ...
            <div className='flex-col flex lg:flex-row  md:gap-20 justify-center items-center '>
                ...
                <div>
                    <h2 className='text-xl text-center md:text-start font-thin font-poppins text-[#AD9AFF] '>About Us</h2>
                    <h1 className='md:text-4xl font-bold text-3xl font-poppins text-[#1F2471] py-4 text-center md:text-start '>How We Can Help You grow Your Business</h1>
